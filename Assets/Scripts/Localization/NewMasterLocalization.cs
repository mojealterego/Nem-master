...
namespace NewMaster.Localization
{
    public static class NewMasterLocalization
    {
        private static readonly Dictionary<string, string> FallbackEnglish = new()
        {
            ...
            [NewMasterTextKeys.SocialMembers] = "Members: {0}",
            [NewMasterTextKeys.SocialCoopScore] = "Co-op score: {0:N0}",
            [NewMasterTextKeys.SocialContribution] = "Your contribution: {0:N0}",
            [NewMasterTextKeys.SocialNextMilestone] = "Next milestone: {0:N0}",
            [NewMasterTextKeys.SocialMemberNotFound] = "Member not found.",
